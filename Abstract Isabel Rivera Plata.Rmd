...
The distribution of all `r length(titles)` the articles across years is :
...
At the time of this report, the number of articles that the team has summarized is `r nrow(gs_done)`:

```{r}
oneswehavedone = match(x = gs_done$PMID, table = pmid) 
...
```{r year and economics,results=FALSE}
